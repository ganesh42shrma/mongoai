      ...
      <div className="border-b border-[#1a1a1a] bg-[#0a0a0a]/95 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl font-medium text-white">Prompt your way to insights</h1>
              {selectedCollection && (
                <p className="text-sm text-[#888888] mt-1">
                  Connected to: <span className="text-[#0ea5e9] font-medium">{selectedCollection}</span>
                </p>
              )}
            </div>
          </div>
          ...
          {!hasResults ? (
            ...
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
              <div className="mb-8">
                ...
                <h2 className="text-2xl font-medium text-white mb-3">What can I help you discover?</h2>
                <p className="text-[#888888] text-base max-w-md mx-auto leading-relaxed">
                  Ask questions about your data and get intelligent insights powered by AI.
                </p>
              </div>
              ...
              {!isConnected && (
                <div className="bg-[#f59e0b]/10 border border-[#f59e0b]/20 rounded-lg p-4 mb-8 max-w-md">
                  <p className="text-[#f59e0b] text-sm">
                    Please enter MongoDB connection details in the sidebar to get started.
                  </p>
                </div>
              )}
              ...
              {isConnected && !selectedCollection && (
                <div className="bg-[#f59e0b]/10 border border-[#f59e0b]/20 rounded-lg p-4 mb-8 max-w-md">
                  <p className="text-[#f59e0b] text-sm">Please select a collection from the sidebar to get started.</p>
                </div>
              )}
              ...
              {isConnected && selectedCollection && (
                <div className="mt-8 max-w-2xl">
                  <h3 className="text-[#888888] text-sm font-medium mb-4">Try asking questions like:</h3>
            ...
            // Results State
            <ResultPanel result={result} summary={summary} cleanedQuery={cleanedQuery} />
          )}
        </div>
      </div>
      ...
      <div className="border-t border-[#1a1a1a] bg-[#0a0a0a]/95 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto px-6 py-4">
          <PromptInput
            ...
            placeholder={!isConnected ? "Enter MongoDB connection details to start..." : "Ask a question..."}
          />
        </div>
      </div>
    </main>

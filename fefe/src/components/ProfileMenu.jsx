...
export default function ProfileMenu({ userData, onLogout }) {
 ...
 return (
   <div className="relative" ref={menuRef}>
     ...
     {open && (
       <div className="absolute right-0 mt-2 w-64 bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg shadow-lg z-500 p-4">
         <div className="mb-3">
         ...
         <Link
           to="/models"
           className="block w-full text-left text-sm text-white hover:underline cursor-pointer mb-2"
